...
${FIELDS.map(input).join("")}
      ...
      <div id="enquiry-thanks" hidden style="text-align:center;padding:10px 4px">
        ...
        <p style="font-size:15.5px;line-height:1.6;color:${GREY};margin:10px 0 0">Our team has reached out about AI training, please check your inbox. If you would rather talk now, book a time with our team below.</p><button type="button" data-calendly hidden style="display:none;font:inherit;font-size:15px;font-weight:700;color:#fff;background:#1BABE5;border:none;padding:13px 24px;min-height:48px;border-radius:12px;cursor:pointer;margin:16px 0 0">Book a time &rarr;</button><a class="vid-noop" data-curriculum hidden style="display:none;font:inherit;font-size:15px;font-weight:700;color:#1BABE5;background:#fff;border:1.5px solid rgba(27,171,229,.45);padding:12px 22px;min-height:48px;border-radius:12px;cursor:pointer;margin:10px 0 0;text-decoration:none;display:inline-flex;align-items:center;justify-content:center" download>Download the curriculum &rarr;</a>
      </div>
    </div>
  </main>
