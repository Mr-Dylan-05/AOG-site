...
${FIELDS.map(input).join("")}
      ...
      <div id="enquiry-thanks" hidden style="text-align:center;padding:10px 4px">
        ...
        <p style="font-size:15.5px;line-height:1.6;color:${GREY};margin:10px 0 0">One of our team will be in touch shortly. If you would rather talk now, call <a href="tel:+61755861400" style="color:#1483B5;font-weight:700;text-decoration:none">(07) 5586 1400</a>.</p>
      </div>
    </div>
  </main>
