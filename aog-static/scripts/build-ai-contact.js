  ...
  <main style="max-width:760px;margin:0 auto;padding:34px 22px 72px">
    ...
    <div style="background:rgba(255,255,255,0.72);backdrop-filter:blur(20px) saturate(150%);-webkit-backdrop-filter:blur(20px) saturate(150%);border:1px solid rgba(255,255,255,0.9);box-shadow:0 26px 62px -32px rgba(11,18,32,0.38);border-radius:22px;padding:26px 24px;margin:28px 0 0;max-width:560px">
      <form data-contact-form data-form="${FORM_KEY}" data-success-panel="#enquiry-thanks" onsubmit="return false" style="display:flex;flex-direction:column;gap:14px">
        ...
        <input type="hidden" name="source" value="${SLUG}"><input type="hidden" name="interest" value="">
...
${FIELDS.map(input).join("")}
      ...
      <div id="enquiry-thanks" hidden style="text-align:center;padding:10px 4px">
        ...
        <div style="font-size:21px;font-weight:800;letter-spacing:-0.025em;color:${INK};margin:15px 0 0">Thanks<span data-greet-name></span>.</div>
        <p style="font-size:15.5px;line-height:1.6;color:${GREY};margin:10px 0 0">Check your email, I&rsquo;ve sent you a time that&rsquo;s free in my calendar. If it doesn&rsquo;t suit there&rsquo;s a link to pick another.</p><button type="button" data-calendly hidden style="display:none;font:inherit;font-size:15px;font-weight:700;color:#fff;background:#1BABE5;border:none;padding:13px 24px;min-height:48px;border-radius:12px;cursor:pointer;margin:16px 0 0">Book a time &rarr;</button><a class="vid-noop" data-curriculum hidden style="display:none;font:inherit;font-size:15px;font-weight:700;color:#1BABE5;background:#fff;border:1.5px solid rgba(27,171,229,.45);padding:12px 22px;min-height:48px;border-radius:12px;cursor:pointer;margin:10px 0 0;text-decoration:none;display:inline-flex;align-items:center;justify-content:center" download>Download the curriculum &rarr;</a>
      </div>
    </div>
  </main>
