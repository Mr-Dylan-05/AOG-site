...
const body = `
  ...
  (function () {
    ...
    function finish() {
      ...
      // The ad's tracking is not read here. It is captured on arrival by
      // utm.js and added to the payload at submit — the quiz is usually
      // several clicks from the page the ad landed on, so by this point the
      // URL no longer carries anything. The hidden utm_* fields above stay as
      // the no-JavaScript shape of the form and are overwritten on submit.
