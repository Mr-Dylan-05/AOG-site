...
const CLOSE = `<section class="campaign-close" id="enquire" aria-label="Get in touch">
        <div class="cc-inner">
          ...
          <p class="cc-copy">Talk to one of our course facilitators.</p>
            ...
            <label style="display:flex;align-items:flex-start;gap:9px;margin:2px 0 0;cursor:pointer"><input type="checkbox" name="marketing_consent" value="yes" checked style="flex:none;width:16px;height:16px;margin:2px 0 0;accent-color:#1BABE5;cursor:pointer"><span style="font-size:12.5px;line-height:1.5;color:#5A6473">By ticking this box, you agree to receive AI training tips and resources to help your team work smarter from Ad On AI &mdash; you can unsubscribe at any time.</span></label><button type="submit" style="font:inherit;font-size:17px;font-weight:700;color:#fff;background:#1BABE5;border:none;padding:16px 26px;min-height:54px;border-radius:14px;cursor:pointer;width:100%;box-shadow:0 14px 26px -12px rgba(27,171,229,0.65)">Send my enquiry &rarr;</button>
            <p data-form-status class="form-status" role="status" aria-live="polite" style="font-size:14px;margin:0"></p>
            <div class="or-rule"><span>or</span></div><button type="button" class="book-inline" data-calendly hidden style="display:none;font:inherit;font-size:16px;font-weight:700;color:#1BABE5;background:#fff;border:1.5px solid rgba(27,171,229,.5);padding:15px 22px;min-height:54px;border-radius:14px;cursor:pointer;width:100%"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="4" width="18" height="18" rx="2"></rect><path d="M16 2v4M8 2v4M3 10h18"></path></svg>Book a time with our team</button><p style="font-size:12.5px;line-height:1.5;color:#8A93A1;margin:2px 0 0">No obligation. We never share your details.</p>
            </form>
            <div id="enquire-thanks" hidden style="text-align:center;padding:10px 4px"><span style="display:inline-flex;align-items:center;justify-content:center;width:52px;height:52px;border-radius:50%;background:rgba(27,171,229,0.12)"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#1BABE5" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6L9 17l-5-5"></path></svg></span><div style="font-size:21px;font-weight:800;letter-spacing:-0.025em;color:#0B1220;margin:15px 0 0">Thanks, we have got that.</div><p style="font-size:15.5px;line-height:1.6;color:#5A6473;margin:10px 0 0">Our team has reached out about AI training, please check your inbox. If you would rather talk now, book a time with our team below.</p><button type="button" data-calendly hidden style="display:none;font:inherit;font-size:15px;font-weight:700;color:#fff;background:#1BABE5;border:none;padding:13px 24px;min-height:48px;border-radius:12px;cursor:pointer;margin:16px 0 0">Book a time &rarr;</button><a class="vid-noop" data-curriculum hidden style="display:none;font:inherit;font-size:15px;font-weight:700;color:#1BABE5;background:#fff;border:1.5px solid rgba(27,171,229,.45);padding:12px 22px;min-height:48px;border-radius:12px;cursor:pointer;margin:10px 0 0;text-decoration:none;display:inline-flex;align-items:center;justify-content:center" download>Download the curriculum &rarr;</a></div>
          </div>
        </div>
      </section>`;
