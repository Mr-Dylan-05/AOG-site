...
const CLOSE = `<section class="campaign-close" id="enquire" aria-label="Get in touch">
        <div class="cc-inner">
          ...
          <p class="cc-copy">Talk to one of our course facilitators.</p>
            ...
            <label style="display:flex;flex-direction:column;gap:5px"><span style="font-size:14px;font-weight:700;letter-spacing:-0.01em;color:#0B1220">Phone</span><input type="tel" name="phone" autocomplete="tel" inputmode="tel" style="font:inherit;font-size:16px;padding:15px 16px;min-height:52px;border-radius:12px;border:1.5px solid rgba(11,18,32,0.16);background:#fff;color:#0B1220;outline:none;width:100%;box-sizing:border-box"><span data-error style="font-size:13px;color:#C2410C"></span></label>
