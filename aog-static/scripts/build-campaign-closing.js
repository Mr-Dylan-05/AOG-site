...
const CLOSE = `<section class="campaign-close" id="enquire" aria-label="Get in touch">
        <div class="cc-inner">
          ...
          <h2 class="cc-head">Ready to start your <b>AI training journey?</b></h2>
            ...
            <div id="enquire-thanks" hidden style="text-align:center;padding:10px 4px"><span style="display:inline-flex;align-items:center;justify-content:center;width:52px;height:52px;border-radius:50%;background:rgba(27,171,229,0.12)"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#1BABE5" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6L9 17l-5-5"></path></svg></span><div style="font-size:21px;font-weight:800;letter-spacing:-0.025em;color:#0B1220;margin:15px 0 0">Thanks<span data-greet-name></span>.</div><p style="font-size:15.5px;line-height:1.6;color:#5A6473;margin:10px 0 0">Keep an eye on your inbox, our team will reach out regarding AI training.</p><button type="button" data-calendly hidden style="display:none;font:inherit;font-size:15px;font-weight:700;color:#fff;background:#1BABE5;border:none;padding:13px 24px;min-height:48px;border-radius:12px;cursor:pointer;margin:16px 0 0">Book a time &rarr;</button><a class="vid-noop" data-curriculum hidden style="display:none;font:inherit;font-size:15px;font-weight:700;color:#1BABE5;background:#fff;border:1.5px solid rgba(27,171,229,.45);padding:12px 22px;min-height:48px;border-radius:12px;cursor:pointer;margin:10px 0 0;text-decoration:none;display:inline-flex;align-items:center;justify-content:center" download>Download the curriculum &rarr;</a></div>
          </div>
        </div>
      </section>`;
