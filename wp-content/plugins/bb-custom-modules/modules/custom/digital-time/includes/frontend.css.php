...
FLBuilderCSS::responsive_rule( array(
	...
	'selector'     => ".fl-node-$id .fl-icon-wrap",
	'prop'         => 'align-items',
) );

// Icon Spacing
if( $settings->inline_stacked === '1' ){
    FLBuilderCSS::responsive_rule( array(
    	'settings'     => $settings,
    	'setting_name' => 'space_below_icon',
    	'selector'     => ".fl-node-$id .fl-module-content .fl-icon",
    	'prop'         => 'margin-bottom',
    ) );
}
else{
