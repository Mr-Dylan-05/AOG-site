...
?>
.fl-node-<?php echo $id; ?> .aog-image-bgcaption .image-wrapper img {
...
.fl-node-<?php echo $id; ?> .aog-image-bgcaption .img-icon {
...
FLBuilderCSS::typography_field_rule( array(
	...
	'selector' 	=> ".fl-node-$id .aog-image-bgcaption .btn .btn-label",
) );

FLBuilderCSS::border_field_rule( array(
    'settings'  => $settings,
    'setting_name'  => 'btn_border',
    'selector'  => ".fl-node-$id .aog-image-bgcaption .btn.btn-outline",
) );