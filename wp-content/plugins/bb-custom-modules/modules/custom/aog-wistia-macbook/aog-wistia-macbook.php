<?php
/**
 * @class aogWistiaVideoModule
 */
class aogWistiaVideoModule extends FLBuilderModule {
	...
	public function __construct()
	{
		...
		parent::__construct(array(
			'name'          	=> __('AOG - Macbook Wistia Video', 'fl-builder'),
			'description'   	=> __('Displays a Wistia video in a macbook.', 'fl-builder'),
 ...
 */
FLBuilder::register_module('aogWistiaVideoModule', array(
	'general' => array(
