...
/**
 * @class aogSliderTestimonialModule
 */
class aogSliderTestimonialModule extends FLBuilderModule {
	...
	public function __construct()
	{
		...
		parent::__construct(array(
			'name'          	=> __('AOG - Slider Testimonials', 'fl-builder'),
	...
	{
		$classname = 'aog-slider-testimonials';
		return $classname;
	}
 ...
 */
FLBuilder::register_module('aogSliderTestimonialModule', array(
	'Content'         => array(
			...
			'style'       => array(
				...
				'fields'        => array(
                    ...
                    'nav_icon_color'        => array(
						...
						'preview'    => array(
                    		'type'     => 'css',
                    		'selector' => '{node} .flickity-button svg',
                            'property' => 'fill',
                    	),
					)
				)
